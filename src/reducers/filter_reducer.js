...
const filter_reducer = (state, action) => {
  if (action.type === LOAD_PRODUCTS) {
    ...
    return {
      ...state,
      // be careful here, we are just copying the values bacause we don't wanna refrence the same place in memory else once we've filter we cannot go back to the original products.
